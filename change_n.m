...
% error_mv = zeros(size(n_list, 2), max_iter, 3);
% error_alg1 = zeros(size(n_list, 2), max_iter, 3);
% error_alg2 = zeros(size(n_list, 2), max_iter, 3);
% error_oracle = zeros(size(n_list, 2), max_iter, 3);
% error_mv_em = zeros(size(n_list, 2), max_iter, 3);
% error_sm_em = zeros(size(n_list, 2), max_iter, 3);
% error_pgd = zeros(size(n_list, 2), max_iter, 3);
% 
% for n_idx = 1 : size(n_list, 2)
%     total_worker = n_list(n_idx);
...
%         
%         [g, h] = top2(q);
%         error_mv_em(n_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
...
%         
%                         [g, h] = top2(q);
%                          error_sm_em(n_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         %====================== PGD ==========================================
...
%         end
%         [g, h] = top2(score);
%         error_pgd(n_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ TopTwo1 ================================
%         [N, M] = size(Y_obs);
%         K = max(Y_obs, [], 'all');
...
%         
%         [g, h] = top2(-del_w);
%         error_alg1(n_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ TopTwo2 ================================
%         
%         
...
%             end
%         end
%         error_alg2(n_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ Oracle ================================
...
%             end
%         end
%         error_oracle(n_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ MV =====================================
%         
%         g = zeros(M, 1);
%         h = zeros(M, 1);
...
%             h(j) = order(2);
%         end
%         error_mv(n_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%     end
% end
% 
