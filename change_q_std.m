...
% max_iter = 10;
% 
% error_mv = zeros(length(q_std_list), max_iter, 3);
% error_alg1 = zeros(length(q_std_list), max_iter, 3);
% error_alg2 = zeros(length(q_std_list), max_iter, 3);
% error_oracle = zeros(length(q_std_list), max_iter, 3);
% error_mv_em = zeros(length(q_std_list), max_iter, 3);
% error_sm_em = zeros(length(q_std_list), max_iter, 3);
% error_pgd = zeros(length(q_std_list), max_iter, 3);
% 
...
%         
%                         [g, h] = top2(q);
%                          error_sm_em(q_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         %====================== PGD ==========================================
...
[h,icons] = legend([A(1), A(2), A(3), A(4), A(5), A(6), A(7)],...
        'MV','MV-D&S', 'OPT-D&S', 'PGD', 'Alg1', 'Alg2', 'Oracle', 'Location', 'eastoutside','FontSize', 14);