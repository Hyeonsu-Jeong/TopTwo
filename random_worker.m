...
% portion_list = 0.1:0.1:0.9;
% max_iter = 10;
% 
% % generate task difficulty
% error_mv = zeros(size(portion_list, 2), max_iter, 3);
% error_alg1 = zeros(size(portion_list, 2), max_iter, 3);
% error_alg2 = zeros(size(portion_list, 2), max_iter, 3);
% error_oracle = zeros(size(portion_list, 2), max_iter, 3);
% error_mv_em = zeros(size(portion_list, 2), max_iter, 3);
% error_sm_em = zeros(size(portion_list, 2), max_iter, 3);
% error_pgd = zeros(size(portion_list, 2), max_iter, 3);
% 
% for portion_idx = 1 : size(portion_list, 2)
%     for times = 1:max_iter
%         fprintf("%d\n", times);
%         portion = portion_list(portion_idx);
%         worker_reliability(1:round(portion * total_worker)) = (0.1 - p_min) * rand(round(portion * total_worker), 1) + p_min;
...
%         
%         [g, h] = top2(q);
%         error_mv_em(portion_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
...
%         
%                         [g, h] = top2(q);
%                          error_sm_em(portion_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         %====================== PGD ==========================================
...
%         end
%         [g, h] = top2(score);
%         error_pgd(portion_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ TopTwo1 ================================
%         [N, M] = size(Y_obs);
%         K = max(Y_obs, [], 'all');
...
%         
%         [g, h] = top2(-del_w);
%         error_alg1(portion_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ TopTwo2 ================================
%         
%         
...
%             end
%         end
%         error_alg2(portion_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ Oracle ================================
...
%             end
%         end
%         error_oracle(portion_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%         % ================================ MV =====================================
%         
%         g = zeros(M, 1);
%         h = zeros(M, 1);
...
%             h(j) = order(2);
%         end
%         error_mv(portion_idx, times, :) = 1 - grade(trimmed_ground_truth, trimmed_most_confusing_answer, g, h) / total_task;
%     end
% end
...
for plot_idx = 1 : 3
    ...
    xlabel('portion of spammers','fontsize',26);
...
%     end
%     title(title_list(plot_idx), 'Interpreter','latex');
%     xlabel('Portion of the random workers','fontsize',26);
%     ylabel('Prediction error', 'fontsize', 26);
%     xlim([x(1) x(end)]);
%     set(gca,'FontSize', 16)
