function [f,F,TestSet] = get_real_annotations(Data,K,M)



[TrainSet,TestSet]=getRandomTrainSet(Data);
N=size(TestSet,1);
[Model1, validationAccuracy1]=trainClassifierFineTree(TrainSet);
%TrainSet=getRandomTrainSet(Data);
[Model2, validationAccuracy2]=trainClassifierMediumTree(TrainSet);
%TrainSet=getRandomTrainSet(Data);
[Model3, validationAccuracy3]=trainClassifierCoarseTree(TrainSet);
%TrainSet=getRandomTrainSet(Data);
[Model4, validationAccuracy4]=trainClassifierFinekNN(TrainSet);
%TrainSet=getRandomTrainSet(Data);
[Model5, validationAccuracy5]=trainClassifierMediumkNN(TrainSet);
%TrainSet=getRandomTrainSet(Data);
[Model6, validationAccuracy6]=trainClassifierCoarsekNN(TrainSet);
%TrainSet=getRandomTrainSet(Data);
[Model7, validationAccuracy7]=trainClassifierCosinekNN(TrainSet);
%TrainSet=getRandomTrainSet(Data);
